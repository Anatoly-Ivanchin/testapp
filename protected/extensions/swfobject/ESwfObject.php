...
class ESwfObject extends CWidget
{
    ...
    public function init()
    {
    	if ($this->containerId == null)
    	    $this->container = 'eswfobject_content_' . date('YdmHis') ;
    	else
    ...
    */
    ...
    protected function createJsCode(){
        ...
        $js .= $this->newLineJS;
        $js .= 'swfobject.embedSWF("' . $this->swfFile . '", "' . $this->container . '", "' . $this->width . '", "' . $this->height . '", "' . $this->playerVersion . '","' . $this->expressInstallFile . '", flashvars' . $this->randomID . ', params' . $this->randomID . ', attributes' . $this->randomID . ');';
    ...
    public function createHtml(){
        $html = '<div id="' . $this->container . '"></div>';
        return $html;
    }
